...
@router.get("/{conn_id}")
async def get_indexes(conn_id: str) -> list[SecondaryIndex]:
...
async def create_index(conn_id: str, body: CreateIndexRequest) -> SecondaryIndex:
...
async def delete_index(conn_id: str, name: str = "", ns: str = "") -> dict:
